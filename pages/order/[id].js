        ...
        <div className="grid md:grid-cols-4 md:gap-5">
          <div className="overflow-x-auto md:col-span-3">
            <div className="card  p-5">
              ...
              {isDelivered ? (
                <div className="alert-success">ارسال در {deliveredAt}</div>
              ) : (
            ...
            <div className="card p-5">
              ...
              {isPaid ? (
                <div className="alert-success">پرداخت در {paidAt}</div>
              ) : (
                <div className="alert-error">پرداحت نشده</div>
              )}
            </div>

            <div className="card overflow-x-auto p-5">
              <h2 className="mb-2 text-lg">جزییات سفارش</h2>
              <table className="min-w-full">
                <thead className="border-b">
                  <tr>
                    <th className="px-5 text-left">ردیف</th>
